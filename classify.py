...
model.load_state_dict(torch.load('/media/jmn/Removable Disk/runs/trained/mobilenet/V1/HSV/best.pt' , map_location='cpu', weights_only=True))
model.eval()

root_dir = '/media/jmn/Removable Disk/database/Macro'
args_path = '/media/jmn/Removable Disk/runs/trained/mobilenet/V1/HSV/args.yaml'
